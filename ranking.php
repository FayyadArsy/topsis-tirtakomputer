...
echo "<b>Hasil Akhir Analisa Metode Topsis Dengan Nilai Bobot Preferensi adalah</b></br>";
echo "Jadi Dapat disimpulkan bahwa alternatif terbaik menggunakan metode TOPSIS adalah <b>".ucwords(($hsl[0][0]))."</b> dengan metode TOPSIS <b>".$hsl[0][1]."</b>.<br><br>";
